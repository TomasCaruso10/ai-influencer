"""Test Chroma + LoRA aiinfluencer1 con prompts NSFW.
Mismo workflow que SFW, mismo LoRA, mismo seed. Solo cambian los prompts."""
...
OUT = ROOT / "outputs" / "chroma_nsfw_test"
...
PROMPTS = [
    ("01_lingerie",   f"aiinfluencer1, {PHYSICAL}, posing in elegant black lace lingerie, soft bedroom lighting, looking at camera, intimate portrait, photorealistic"),
    ("02_topless",    f"aiinfluencer1, {PHYSICAL}, artistic topless portrait, arms covering chest, soft window light, intimate boudoir style, photorealistic"),
    ("03_bedroom",    f"aiinfluencer1, {PHYSICAL}, sensual pose on bed, white sheets, sheer nightgown, soft morning light, photorealistic"),
    ("04_shower",     f"aiinfluencer1, {PHYSICAL}, post-shower wrapped in white towel, wet hair, bathroom mirror reflection, intimate, photorealistic"),
]
