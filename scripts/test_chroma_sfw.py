"""Test Chroma + LoRA aiinfluencer1 con prompts SFW idénticos a los de FLUX test final.
Comparación directa: misma seed, mismo prompt, mismo LoRA, distinto modelo base (Chroma vs FLUX dev).
Si las caras se parecen entre Chroma y FLUX → LoRA es portable. Si difieren → ajustar strength.
"""
...
OUT = ROOT / "outputs" / "chroma_sfw_test"
